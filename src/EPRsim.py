...
def simulate(Parameters):
    ...
    Isotropic/fast-motion
		...
		the implicit Breit-Rabi formula [#f1]_ in a fixed-point iteration.
		Anisotropic line-broadening effects in the fast-motion regime
		are calculated via the Kivelson formula [#f2]_.
    ...
    Solid-state
		...
		of eigenvalues and transition probabilitites (similar to [#f1]_).
    ...
    References
    ----------
    .. [#f1] : S. Stoll, A. Schweiger, J. Magn. Reson., 2006, 178, 42-55

    .. [#f2] : N. M. Atherton, Principles of Electron Spin Resonance, 1993
